...
class PartialBatchExecutionTest {
    ...
    private static final class TestKey extends AEKey {
        ...
        @Override public Identifier getId() { return Identifier.fromNamespaceAndPath("thunderbolt_test", id); }
    ...
    private static final class TestKeyType extends AEKeyType {
        TestKeyType() {
            super(Identifier.fromNamespaceAndPath("thunderbolt_test", "partial_batch_key"),
