...
public record PlanningDiagnostics(
        ...
        int consumptionOptimizationImprovements,
        long consumptionOptimizationNanos) {

    /** Source-compatible constructor for callers predating feasible-plan optimization. */
    public PlanningDiagnostics(
            ...
            int lowWidthCutoffs, int lowWidthIntegerNodes, int missingRefinementProbes,
            int missingRefinementImprovements, long missingRefinementNanos) {
        this(reachableWorkEstimate, reachableItems, reachablePatterns, inputEdges, contendedOutputs,
                ...
                searchNanos, totalNanos, separatorWidthPeak, lowWidthAttempts, lowWidthSolved,
    ...
    PlanningDiagnostics withConsumptionOptimization(int probes, int improvements, long nanos, long total) {
        return new PlanningDiagnostics(reachableWorkEstimate, reachableItems, reachablePatterns, inputEdges, contendedOutputs,
                ...
                lowWidthInfeasible, lowWidthCutoffs, lowWidthIntegerNodes, missingRefinementProbes,
                missingRefinementImprovements, missingRefinementNanos, probes, improvements, nanos);
    }
